...
COMMENT ON COLUMN geochronic.colaus_b.antihta IS 'Antihypertensive drug treatment';
...
COMMENT ON COLUMN geochronic.colaus_b.bmi_cat2 IS 'BMI categories (+ underw)';
...
COMMENT ON COLUMN geochronic.colaus_f1.f1antihta IS 'Antihypertensive drug treatment';
...
COMMENT ON COLUMN geochronic.colaus_f1.f1bmi_cat2 IS 'BMI categories (+ underw)';
...
COMMENT ON COLUMN geochronic.colaus_f2.f2antihta IS 'Antihypertensive drug treatment';
