...
# CoLaus participants
indiv <- load_participants(con, period_shrt="b", extent=laus$extent)
# st_write(indiv, "../processed_data/events_baseline_analysis.geojson", delete_dsn = TRUE)
indiv <- st_read("../processed_data/events_baseline_analysis.geojson")
...
print(paste("Number of Baseline individuals in Lausanne:", nrow(indiv)))
...
sink("../results/spatial_disease_risk/hypertension/baseline/spatial_variation_risk_hypertension.txt")
...
sink("../results/spatial_disease_risk/obesity/baseline/spatial_variation_risk_obesity.txt")
cat(paste0("Date:", Sys.Date(),'\n')) #Overwrite the file
...
sink("../results/spatial_disease_risk/diabetes/baseline/spatial_variation_risk_diabetes.txt")
cat(paste0("Date:", Sys.Date(),'\n')) #Overwrite the file
...
sink("../results/spatial_disease_risk/dyslipidemia/baseline/spatial_variation_risk_dyslipidemia.txt")
cat(paste0("Date:", Sys.Date(),'\n')) #Overwrite the file
