...
for (period in periods){
  ...
  write("Do not use the results of F2 for the paper as we didn't remove individuals without confounders and outside hectares (N=3703 for now). \nStatistics for this will be printed in describe_participants.R", file_res=f)
